                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <section id="contact" class="section">
                            <div class="container">
                                ...
                                <div class="text-center-home">
                                    <p>//Funilat0r <span class="version"></span> é uma ferramenta para automatizar os
                                    ...
                                    <div id="contact-card" class="col-sm-12 col-xs-12">
                                        ...
                                        <div class="card">
                                            <div class="card-content">
                                                <!---->
                                                <form method="post" action="index.php" id="contact-form" name="c-form" class="form-block">
                                                    <h4 class="title-result">//calcular</h4>
                                                    <h5>informe abaixo <span><a href="pages/easteregg.html"
                                                    ...
                                                    <div class="input-field">
                                                        <input id="oportunidades" type="number"
                                                               class="validate valor-input"
                                                               name="oportunidades">
                                                    ...
                                                    <!--VISITANTES-->
                                                    <div class="input-field">
                                                        <input id="visitantes" type="number"
                                                               class="validate valor-input"
                                                               name="visitantes">
                                                    ...
                                                    <div class="input-field">
                                                        <input id="cac" type="number" class="validate valor-input"
                                                               name="cac"
                                                        >
                                                    ...
                                                    <!--CPL-->
                                                    <div class="input-field">
                                                        <input id="cpl" type="number" class="validate valor-input"
                                                               name="cpl"
                                                        >
                                                    ...
                                                    <!--LUCRO-->
                                                    <div class="input-field">
                                                        <input id="lucro" type="number" class="validate valor-input"
                                                               name="lucro"
                                                        >
                        ...
                        <section class="content-result">
                            <ul>
                            <?php
                            include "calcs_php/chamada_calcs.php";
                            calc();
